<?php
	...
	$title="Configuración | Boutique Tendy";
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 toppad" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title"><i class='fa fa-cog'></i> Configuración</h3>
            </div>
              ...
              <div class="row">
					...
					<div class="row">
  						<div class="col-md-12">
							<div class="form-group">
								<input class='filestyle' data-iconName="fa fa-search"  data-buttonText="Seleccionar" type="file" name="imagefile" id="imagefile" onchange="upload_image();">
							</div>
						</div>
				...
				<div class='col-md-12' id="resultados_ajax"></div><!-- Carga los datos ajax -->
                 ...
                 <div class="panel-footer text-center">
                            ...
                            <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-refresh"></i> Actualizar datos</button>
